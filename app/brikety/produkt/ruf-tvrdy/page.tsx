...
const priceTiers: PriceTier[] = [
  { min: 10, max: 100, pricePerKg: 4.50, description: 'Malé balení' },
  { min: 110, max: 250, pricePerKg: 4.20, description: 'Střední balení' },
  { min: 260, max: 500, pricePerKg: 4.00, description: 'Velké balení' },
  { min: 510, max: 1000, pricePerKg: 3.80, description: 'Velkoobjemové balení' }
]

export default function RufTvrdyPage() {
  ...
  const features = [
    'Dlouhá doba hoření až 3x déle než běžné dřevo',
    'Výhřevnost 18 MJ/kg',
    'Ekologické - vyrobené z dřevního odpadu',
    'Bez chemických přísad',
    'Ideální pro krby, kamna a grily',
    'Certifikované kvality'
  ]

  const specifications = [
    { label: 'Typ briket', value: 'RUF Tvrdé brikety' },
    { label: 'Výhřevnost', value: '18 MJ/kg' },
    { label: 'Vlhkost', value: 'Pod 10%' },
    { label: 'Rozměry', value: '15 x 6,5 x 5,5 cm' },
    { label: 'Hmotnost kusu', value: '0,8 kg' },
  ...
  const reviews = [
    {
      ...
      rating: 5,
      date: '15. 12. 2024',
      comment: 'Výborné brikety, hoří dlouho a intenzivně. Určitě doporučuji.'
    },
    {
      id: 2,
      ...
      rating: 5,
      date: '10. 12. 2024',
      comment: 'Kvalitní brikety za rozumnou cenu. Doprava byla rychlá.'
    },
    {
      id: 3,
      name: 'Petr Černý',
      rating: 4,
      date: '5. 12. 2024',
      comment: 'Spokojenost, brikety jsou opravdu suché a dobře hoří.'
    }
  ]
      ...
      <div className="bg-forest-50 border-b border-forest-200">
        <div className="container-max px-4 py-3">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <ChevronRightIcon className="h-4 w-4 text-forest-400" />
            <span className="text-forest-800 font-medium">RUF Tvrdé brikety</span>
          </nav>
        </div>
      </div>
            ...
            <div>
              <div className="mb-6">
                ...
                <p className="text-forest-600 mb-4">
                  Kvalitní tvrdé brikety s dlouhou dobou hoření. Ideální pro krby, kamna a grily.
                </p>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-forest-600">Krbová kamna</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <CheckIcon className="h-5 w-5 text-green-500" />
                        <span className="text-forest-600">Kachlová kamna</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <CheckIcon className="h-5 w-5 text-green-500" />
                        <span className="text-forest-600">Krbové vložky</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <CheckIcon className="h-5 w-5 text-green-500" />
                        <span className="text-forest-600">Grilování</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <CheckIcon className="h-5 w-5 text-green-500" />
                        <span className="text-forest-600">Kotle na tuhá paliva</span>
                      </div>
                    </div>
                  </div>
                </div>
